...
export default StyleSheet.create({
    ...
    primaryButton: { borderRadius: 25, width: "100%", marginBottom: 5, overflow: "hidden" },
    gradientButton: { padding: 15, alignItems: "center", borderRadius: 25 },
    ...
    secondaryButton: { borderWidth: 2, borderColor: "#00DB83", borderRadius: 25, padding: 15, alignItems: "center", marginBottom: 25 },
